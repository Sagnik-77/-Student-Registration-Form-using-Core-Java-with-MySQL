...
public class Signup extends JFrame implements ActionListener{
	...
	long randomNumber;
	JTextField userNameTextField,fatherNameTextField,userEmailTextField,
	...
	Signup(){
		...
		fatherNameTextField.setFont(new Font("Arial",Font.PLAIN,18));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		try {
			if(userName.equals("")) {
				...
				String query = "INSERT INTO register VALUES('"+formno+"','"+userName+"','"+fName+"','"+dob+"','"+gender+"','"+email+"','"+address+"','"+city+"','"+state+"','"+pincode+"')";
